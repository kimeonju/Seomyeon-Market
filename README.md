...
<style>
.hero-bg {background: linear-gradient(180deg, rgba(34,197,94,0.08), rgba(34,197,94,0.02));}
...
<section class="hero-bg py-12">
  <div class="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-6 items-center">
    ...
    <div class="bg-white rounded-lg shadow-inner p-4 text-center">
      <p class="font-semibold">취나물(1kg)</p>
...
<section id="posts" class="bg-white py-10">
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div id="post-list" class="scroll-container">
      <div class="border p-4 w-96 flex-shrink-0 search-item bg-gray-50 rounded">
        <h4 class="font-semibold">환영 인사</h4>
        <p>서면나눔5일장에 오신 것을 환영합니다! 🌿 싱싱한 취나물 판매 중입니다.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div class="overflow-auto bg-gray-50 p-4 rounded">
      <table class="min-w-full text-sm text-left">
        ...
        <tbody>
          <tr class="border-t"><td class="p-2">매달 4일, 9일</td><td class="p-2">취나물</td></tr>
          <tr class="border-t"><td class="p-2">매달 14일, 19일</td><td class="p-2">취나물</td></tr>
          <tr class="border-t"><td class="p-2">매달 24일, 29일</td><td class="p-2">취나물</td></tr>
        </tbody>
      </table>
    </div>
  </div>
...
searchInput.addEventListener('input', ()=>{
  ...
  [...productList.children, ...postList.children].forEach(el=>{
  ...
  noResults.classList.toggle('hidden', visible || q==="");
});
</script>
